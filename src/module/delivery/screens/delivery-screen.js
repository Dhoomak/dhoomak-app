...
const [data, setData] = useState([
  { id: '1', date: '2023-11-01', time: '09:30 AM', status: 'Delivered', description: 'House 68, Sector 38, Gurugram' },
  { id: '2', date: '2023-12-08', time: '02:45 PM', status: 'To be delivered', description: 'House 68, Sector 40, Gurugram' },
  { id: '3', date: '2023-11-13', time: '01:15 PM', status: 'Cancelled', description: 'Lorem ipsum dolor sit amet, cons' },
]);

  const unitQuantityType = ["Sort by Date", "Sort by Delivery", "Sort by Name", "Sort by Status"];
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <TableRow data={item} navigate={navigateToDetails} tableConfig={tableHeaderConfig} renderCell={(key, value) => (
            <View>
              <Text>{value}</Text>
            </View>
          )} />
