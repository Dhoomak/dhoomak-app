    ...
    return (
        <View className='flex-row gap-x-2 bg-white'>
            ...
            <View className='flex-2 justify-center'>
                <Text className='text-sm text-black font-semibold truncate'>{name}</Text>
            ...
            <View className='flex-1 justify-center items-center'>
                <Text className='text-xs text-black font-semibold truncate text-center mb-1'>{unitAdded} {unitPrice ? `x ${STRINGS.rupeeSign}${unitPrice}` : ``}</Text>
            </View>
            <View className='flex-1 justify-center items-center'>
                {unitPrice ? <Text className='text-sm text-black font-bold truncate text-center mb-1'>{STRINGS.rupeeSign}{unitAdded * unitPrice}</Text> : <></>}
            </View>
        </View>
    );
}
